...
* https://netapppub.slack.com/#astra["*Obtenir de l'aide via Slack*"^]: Dans le canal conteneurs de l'espace de travail thePub, entrez en contact avec vos pairs et vos experts.
